...
use DWS_LOWC_Deps\DI\Definition\Exception\InvalidDefinition;
use DWS_LOWC_Deps\DI\Definition\FactoryDefinition;
use DWS_LOWC_Deps\DI\Definition\Helper\DefinitionHelper;
use DWS_LOWC_Deps\DI\Definition\InstanceDefinition;
use DWS_LOWC_Deps\DI\Definition\ObjectDefinition;
use DWS_LOWC_Deps\DI\Definition\Resolver\DefinitionResolver;
use DWS_LOWC_Deps\DI\Definition\Resolver\ResolverDispatcher;
use DWS_LOWC_Deps\DI\Definition\Source\DefinitionArray;
use DWS_LOWC_Deps\DI\Definition\Source\MutableDefinitionSource;
use DWS_LOWC_Deps\DI\Definition\Source\ReflectionBasedAutowiring;
use DWS_LOWC_Deps\DI\Definition\Source\SourceChain;
use DWS_LOWC_Deps\DI\Definition\ValueDefinition;
use DWS_LOWC_Deps\DI\Invoker\DefinitionParameterResolver;
use DWS_LOWC_Deps\DI\Proxy\ProxyFactory;
use InvalidArgumentException;
use DWS_LOWC_Deps\Invoker\Invoker;
use DWS_LOWC_Deps\Invoker\InvokerInterface;
use DWS_LOWC_Deps\Invoker\ParameterResolver\AssociativeArrayResolver;
use DWS_LOWC_Deps\Invoker\ParameterResolver\Container\TypeHintContainerResolver;
use DWS_LOWC_Deps\Invoker\ParameterResolver\DefaultValueResolver;
use DWS_LOWC_Deps\Invoker\ParameterResolver\NumericArrayResolver;
use DWS_LOWC_Deps\Invoker\ParameterResolver\ResolverChain;
