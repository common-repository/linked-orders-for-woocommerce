...
namespace DWS_LOWC_Deps\DI\Proxy;

use DWS_LOWC_Deps\ProxyManager\Configuration;
use DWS_LOWC_Deps\ProxyManager\Factory\LazyLoadingValueHolderFactory;
use DWS_LOWC_Deps\ProxyManager\FileLocator\FileLocator;
use DWS_LOWC_Deps\ProxyManager\GeneratorStrategy\EvaluatingGeneratorStrategy;
use DWS_LOWC_Deps\ProxyManager\GeneratorStrategy\FileWriterGeneratorStrategy;
use DWS_LOWC_Deps\ProxyManager\Proxy\LazyLoadingInterface;
/**
